...
export function ClinicalScopePanel({
  ...
  return (
    <article className="overflow-hidden rounded-[22px] border border-line bg-paper shadow-[0_16px_50px_rgba(7,28,42,0.055)]">
      <div className="grid gap-5 border-b border-line bg-porcelain p-5 md:grid-cols-[1fr_auto] md:items-start">
        <div>
          <div className="flex items-center gap-3 text-cobalt">
            <Icon aria-hidden="true" size={23} />
            <p className="label-caps">Service area</p>
          </div>
          <h2 className="mt-3 max-w-xl font-display text-3xl font-medium leading-tight text-ink">
            {area}
          </h2>
        </div>
